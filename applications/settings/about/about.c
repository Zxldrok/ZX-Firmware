...
static DialogMessageButton zx_info_screen(DialogsApp* dialogs, DialogMessage* message) {
    DialogMessageButton result;

    const char* screen_header = "Zx Firmware\n";
...
static DialogMessageButton zx_info_screen2(DialogsApp* dialogs, DialogMessage* message) {
    DialogMessageButton result;
...
static DialogMessageButton zx_info_screen3(DialogsApp* dialogs, DialogMessage* message) {
    DialogMessageButton result;
